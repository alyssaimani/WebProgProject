...
<div class="d-flex justify-content-center">
    <div class="card p-5 m-5 d-flex flex-column" style="width: 75%; height: 600px">
        <form action="/product" method="POST" style="width: 100%"  enctype="multipart/form-data">
            @csrf
            <div class="d-flex justify-content-center">
            ...
            <div class="mb-3">
                ...
                <input type="text" class="form-control" name="name" id="name" placeholder="Enter Product Name..." value="{{ old('name') }}" autofocus>
            </div>
            <div class="mb-3">
